...
export class DashboardComponent implements AfterViewInit {
    ...
    public lineChartData1: Array<object> = [
        { data: [0, 150, 110, 240, 200, 200, 300, 200, 380, 300, 400, 380], label: 'Sales' }
    ];

    public lineChartLabels1: Array<string> = ['January', 'February', 'March', 'April', 'May', 'June', 'July','most','people','dontcare'];
